...
For the CIFAR-10 dataset, it is possible to see on the hit maps that the model is trying to put the samples of the same class together. But these results need to be highly improved, since the samples of different classes still mixed in the map. Also, the purity for this clustering is low. <br/>
